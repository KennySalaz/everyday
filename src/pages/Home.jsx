...
const gallery = [
  {
    src: ig1,
    label: "Zarcillos Lazo Dorado",
    tag: "Zarcillos",
    desc: "Zarcillos tipo lazo en baño de oro. Delicados, femeninos y perfectos para el día a día.",
  },
  {
    src: ig2,
    label: "Brazalete + Anillo Fluido",
    tag: "Brazaletes",
    desc: "Set de brazalete rígido y anillo de forma orgánica en baño de oro 18k. Minimalismo de lujo.",
  },
  {
    src: ig3,
    label: "Anillo + Brazalete Orgánico",
    tag: "Anillos",
    desc: "Diseño asimétrico y moderno. Anillo abierto con brazalete torsionado — combinación única.",
  },
  {
    src: ig4,
    label: "Colección Completa",
    tag: "Colección",
    desc: "Anillos lazo, ear cuffs con cadena, aretes argolla y cadena lariat. Todo Everyday.",
  },
  {
    src: ig5,
    label: "Pulseras Unisex",
    tag: "Pulseras",
    desc: "Pulsera trenzada + cordón náutico con dije de luna. Estilo urbano para todos.",
  },
  {
    src: ig6,
    label: "Zarcillos Lazo + Anillo",
    tag: "Sets",
    desc: "La combinación perfecta: zarcillos lazo dorado con anillo a juego.",
  },
  {
    src: pic1,
    label: "Pieza Destacada",
    tag: "Colección",
    desc: "Una de nuestras piezas más queridas por la comunidad Everyday.",
  },
  {
    src: pic2,
    label: "Estilo del Día",
    tag: "Lifestyle",
    desc: "Accesorios pensados para lucirlos todos los días, en cualquier ocasión.",
  },
  {
    src: pic3,
    label: "Dorado Everyday",
    tag: "Zarcillos",
    desc: "El dorado que nunca falla. Elegancia sencilla para tu look diario.",
  },
  {
    src: pic4,
    label: "Brazalete Dorado",
    tag: "Brazaletes",
    desc: "Brazalete minimalista que combina con todo. Baño de oro de alta duración.",
  },
  {
    src: pic5,
    label: "Cadena Delicada",
    tag: "Cadenas",
    desc: "Cadena fina para usar sola o en capas. Versátil y atemporal.",
  },
  {
    src: pic6,
    label: "Set Anillos",
    tag: "Anillos",
    desc: "Anillos para apilar y combinar a tu gusto. Sin reglas, puro estilo.",
  },
  {
    src: picA,
    label: "Look Completo",
    tag: "Sets",
    desc: "Así se combinan nuestras piezas. Un look dorado de pies a cabeza.",
  },
  {
    src: picB,
    label: "Detalle Dorado",
    tag: "Colección",
    desc: "Los pequeños detalles hacen la diferencia. Cada pieza diseñada con cuidado.",
  },
  {
    src: picC,
    label: "Argollas Everyday",
    tag: "Zarcillos",
    desc: "Argollas clásicas con acabado dorado. El básico que nunca debe faltar.",
  },
  {
    src: picD,
    label: "Pulsera Tejida",
    tag: "Pulseras",
    desc: "Pulsera con diseño artesanal. Perfecta para combinar con brazaletes dorados.",
  },
  {
    src: picE,
    label: "Estilo Everyday",
    tag: "Lifestyle",
    desc: "Nuestro estilo: sencillo, dorado y para todos los días.",
  },
  {
    src: picF,
    label: "Nueva Colección",
    tag: "Colección",
    desc: "Piezas recién llegadas. Diseños frescos para renovar tu look.",
  },
  {
    src: picG,
    label: "Ear Cuff + Cadena",
    tag: "Ear Cuffs",
    desc: "Ear cuff con colgante de cadena. Tendencia que no pasa de moda.",
  },
  {
    src: picH,
    label: "Anillo Abierto",
    tag: "Anillos",
    desc: "Anillo ajustable con forma fluida. Úsalo en cualquier dedo.",
  },
  {
    src: picI,
    label: "Piezas en Mano",
    tag: "Lifestyle",
    desc: "Nuestras piezas, en tus manos. Diseñadas para brillar contigo.",
  },
  {
    src: picJ,
    label: "Everyday Post",
    tag: "Colección",
    desc: "Inspiración directa de nuestro feed. Piezas para el día a día.",
  },
  {
    src: picK,
    label: "Look Dorado",
    tag: "Lifestyle",
    desc: "Un look completo con toques dorados Everyday.",
  },
  {
    src: picL,
    label: "Diseño Especial",
    tag: "Colección",
    desc: "Pieza de edición especial. Delicada y llena de personalidad.",
  },
  {
    src: picM,
    label: "Colección Gemini",
    tag: "Colección",
    desc: "Nueva colección con diseños geométricos y orgánicos.",
  },
  {
    src: picN,
    label: "Sesión Everyday",
    tag: "Lifestyle",
    desc: "Detrás de cámara de nuestras sesiones. Magia y accesorios.",
  },
];
      ...
      <div className="ed-container">
        <FadeUp className="ed-section-header">
          ...
          <p className="ed-section-sub">
            Cada pieza cuenta una historia. Haz clic en las fotos para
            explorarlas.
          </p>
        </FadeUp>
...
function CareGuide() {
  ...
  return (
    <section className="ed-care ed-has-logo-bg">
      <div
        className="ed-logo-bg-grid ed-logo-bg-grid--light"
        aria-hidden="true"
      >
        {[0, 1, 2, 3, 4, 5].map((i) => (
          <img key={i} src={i % 4 === 1 ? logoBgSun : logoBg} alt="" />
        ))}
      </div>
      <div className="ed-container">
        <div className="ed-care-inner">
          <FadeUp className="ed-care-header">
            ...
            <p className="ed-care-intro">
              Cada accesorio Everyday está hecho para acompañarte en tu día a
              día. Cuidarlo es parte de la magia ✨ Aquí te contamos cómo:
            </p>
          </FadeUp>
    ...
    <div className="ed-home">
      ...
      <section className="ed-hero">
        ...
        <div className="ed-container ed-hero-content">
          ...
          >
            Accesorios para lucir todos los días —<br />
      ...
      <section className="ed-about ed-has-logo-bg">
        <div className="ed-logo-bg-grid" aria-hidden="true">
          {[0, 1, 2, 3, 4, 5].map((i) => (
            <img key={i} src={i % 3 === 2 ? logoBgSun : logoBg} alt="" />
          ))}
        </div>
        <div className="ed-container ed-about-grid">
          ...
          <FadeUp delay={0.15} className="ed-about-text">
            ...
            <h2 className="ed-about-title">Accesorios para ti.</h2>
            <p>
              En Everyday encontraras zarcillos, cadenas,brazaletes, anillos,
              ear cuf y mas cosas que puedan complementar tu estilo, para
              brillar en tu dia a dia. Desde lo mas sutil hasta lo que roba
              miradas
            </p>
            <p>
      ...
      <section className="ed-cta">
        ...
        <div
          className="ed-logo-bg-grid ed-logo-bg-grid--cta"
          aria-hidden="true"
        >
          {[0, 1, 2, 3, 4, 5].map((i) => (
            <img key={i} src={i % 3 === 1 ? logoBgSun : logoBg} alt="" />
          ))}
        </div>
        <div className="ed-container ed-cta-content">
          <FadeUp>
            ...
            <p className="ed-cta-sub">
              Zarcillos, cadenas, brazaletes, anillos y pulseras — encuentra la
              pieza que se hará parte de tu historia.
            </p>
